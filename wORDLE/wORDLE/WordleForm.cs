...
namespace Wordle
{
    ...
    {
        private const string WordsTextFile = @"C:\Users\Mr_Blaza\Desktop\LUYBCHO\ÈÒ\gihub\School-Corses\Practical Project - Wordle\Wordle\wordsForWordle.txt";  // wordsForWordle.txt
